...
from CalSimul import (calcular_simul, 
                      cinematicaInversa, 
                      Jacobiano,
                      obtener_splines,
                      evaluar_splines_c, 
...
# =============================================================================
        ...
        def cargar():
            try:
                ruta_archivo = filedialog.askopenfilename(
                    ...
                    filetypes=[("Archivo NumPy", "*.npy")],
                    title="cargar trayectoria...")
                varbls.bezier = np.load(ruta_archivo)
        ...
        def calibrar():
            try:
                ...
                print("Archivo calibracion.json actualizado.")
